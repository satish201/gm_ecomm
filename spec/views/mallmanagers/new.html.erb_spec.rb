...
describe "mallmanagers/new.html.erb" do
  before(:each) do
    assign(:mallmanager, stub_model(Mallmanager,
      :username => "MyString",
      :email => "MyString",
  ...
  it "renders new mallmanager form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => mallmanagers_path, :method => "post" do
